        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="section-title">
                    ...
                    <p>Anda dapat melihat detail Pendaftaran pada halaman ini</p>
                </div>
            </div>
        </div>
        <div class="row">
                    ...
                    <div class="row">
                        <div class="col-lg-12 col-md-6 col-12">
                            <div class="form-group">
                                <label class="form-group" for="">Nama :</label>
                                <input name="nama_sebelumnya" type="text" value="<?php echo $pendaftaran['nama']; ?>" placeholder="" disabled>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-lg-12 col-md-6 col-12">
                            <div class="form-group">
                                <label class="form-group" for="">Gambar KTP :</label>
                                <img src="<?php echo base_url() . '/gambar/' . $pendaftaran['gambar'];  ?>" alt="">
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-lg-12 col-md-6 col-12">
                            <div class="form-group">
                                <label class="form-group" for="">Nomor KTP</label>
                                <input name="no_ktp" type="text" value="<?php echo $pendaftaran['no_ktp']; ?>" placeholder="" disabled>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-lg-12 col-md-6 col-12">
                            <div class="form-group">
                                ...
                                <input name="alamat" type="text" value="<?php echo $pendaftaran['alamat']; ?>" placeholder="" disabled>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-lg-12 col-md-6 col-12">
                            <div class="form-group">
                                <label class="form-group" for="">RT.</label>
                                <input name="rt" type="text" value="<?php echo $pendaftaran['rt']; ?>" placeholder="" disabled>
                                <label class="form-group" for="">RW. </label>
                                <input name="rw" type="text" value="<?php echo $pendaftaran['rw']; ?>" placeholder="" disabled>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-lg-12 col-md-6 col-12">
                            <div class="form-group">
                                <label class="form-group" for="">Nomor HP</label>
                                <input name="no_hp" type="text" value="<?php echo $pendaftaran['no_hp']; ?>" placeholder="" disabled>
                            </div>
                        </div>
                    </div>
                </form>
