        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="section-title">
                    ...
                    <p>Anda dapat melihat detail tagihan pada halaman ini</p>
                </div>
            </div>
        </div>
        <div class="row">
                    ...
                    <div class="row">
                        <div class="col-lg-12 col-md-6 col-12">
                            <div class="form-group">
                                ...
                                <input name="name" type="text" value="<?php echo $tagihan['nama']; ?>" placeholder="" disabled>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-lg-12 col-md-6 col-12">
                            <div class="form-group">
                                ...
                                <input name="name" type="text" value="<?php echo $tagihan['alamat']; ?>" disabled>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-lg-12 col-md-6 col-12">
                            <div class="form-group">
                                ...
                                <input name="name" type="text" value="<?php echo $tagihan['no_sambungan']; ?>" disabled>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-lg-12 col-md-6 col-12">
                            <div class="form-group">
                                ...
                                <input name="name" type="text" value="<?php echo $tagihan['no_pelanggan']; ?>" disabled>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-lg-12 col-md-6 col-12">
                            <div class="form-group">
                                ...
                                <input name="name" type="text" value="<?php echo $tagihan['jumlah_rekening']; ?>" disabled>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-lg-12 col-md-6 col-12">
                            <div class="form-group">
                                ...
                                <input name="name" type="text" value="<?php echo $tagihan['tagihan']; ?>" disabled>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-lg-12 col-md-6 col-12">
                            <div class="form-group">
                                ...
                                <input name="name" type="text" value="<?php echo $tagihan['denda']; ?>" disabled>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-lg-12 col-md-6 col-12">
                            <div class="form-group">
                                ...
                                <input name="name" type="text" value="<?php echo $tagihan['segel']; ?>" disabled>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-lg-12 col-md-6 col-12">
                            <div class="form-group">
                                ...
                                <input name="name" type="text" value="<?php echo $tagihan['total_tagihan']; ?>" disabled>
                            </div>
                        </div>
                    </div>
            </div>
