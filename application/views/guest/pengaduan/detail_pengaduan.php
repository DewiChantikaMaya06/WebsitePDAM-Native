        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="section-title">
                    ...
                    <p>Anda dapat melihat detail Pengaduan pada halaman ini</p>
                </div>
            </div>
        </div>
        <div class="row">
                    ...
                    <div class="row">
                        <div class="col-lg-12 col-md-6 col-12">
                            <div class="form-group">
                                ...
                                <input name="nama" type="text" value="<?php echo $pengaduan['nama']; ?>" placeholder="" disabled>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-lg-12 col-md-6 col-12">
                            <div class="form-group">
                                ...
                                <input name="alamat" type="text" value="<?php echo $pengaduan['alamat']; ?>" placeholder="" disabled>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-lg-12 col-md-6 col-12">
                            <div class="form-group">
                                ...
                                <input name="no_hp" type="text" value="<?php echo $pengaduan['no_hp']; ?>" placeholder="" disabled>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-lg-12 col-md-6 col-12">
                            <div class="form-group">
                                <label class="form-group" for="">Nomor Pelanggan :</label>
                                <input name="no_pelanggan" type="text" value="<?php echo $pengaduan['no_pelanggan']; ?>" placeholder="" disabled>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-lg-12 col-md-6 col-12">
                            <div class="form-group">
                                <label class="form-group" for="">Jenis :</label>
                                <input name="jenis" type="text" value="<?php echo $pengaduan['jenis']; ?>" placeholder="" disabled>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-lg-12 col-md-6 col-12">
                            <div class="form-group">
                                ...
                                <input name="isi_pengaduan" type="text" value="<?php echo $pengaduan['isi_pengaduan']; ?>" placeholder="" disabled>
                            </div>
                        </div>
                    </div>
