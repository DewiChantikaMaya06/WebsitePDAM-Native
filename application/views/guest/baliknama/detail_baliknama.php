        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="section-title">
                    <h2>Detail Balik Nama</h2>
                    <p>Anda dapat melihat detail Balik Nama pada halaman ini</p>
                </div>
            </div>
        </div>
        <div class="row">
                    ...
                    <div class="row">
                        <div class="col-lg-12 col-md-6 col-12">
                            <div class="form-group">
                                ...
                                <img src="<?php echo base_url() . '/gambar/' . $baliknama['gambar_ktp'];  ?>" alt="">
                            </div>
                            <div class="form-group">
                                <label class="form-group" for="">Gambar Rekening :</label>
                                <img src="<?php echo base_url() . '/gambar/' . $baliknama['gambar_rekening'];  ?>" alt="">
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-lg-12 col-md-6 col-12">
                            <div class="form-group">
                                ...
                                <input name="nama_sebelumnya" type="text" value="<?php echo $baliknama['nama_sebelumnya']; ?>" placeholder="" disabled>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-lg-12 col-md-6 col-12">
                            <div class="form-group">
                                ...
                                <input name="nama_pengaju" type="text" value="<?php echo $baliknama['nama_pengaju']; ?>" placeholder="" disabled>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-lg-12 col-md-6 col-12">
                            <div class="form-group">
                                ...
                                <input name="no_ktp" type="text" value="<?php echo $baliknama['no_ktp']; ?>" placeholder="" disabled>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-lg-12 col-md-6 col-12">
                            <div class="form-group">
                                ...
                                <input name="alamat" type="text" value="<?php echo $baliknama['alamat']; ?>" placeholder="" disabled>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-lg-12 col-md-6 col-12">
                            <div class="form-group">
                                ...
                                <input name="no_hp" type="text" value="<?php echo $baliknama['no_hp']; ?>" placeholder="" disabled>
                            </div>
                        </div>
                    </div>
