                ...
                <div class="row">
                    <div class="col-12">
                        <div class="single-main">
                            <h1 class="news-title" style="color: #26547c;font-weight: bold; font-size:40px ; margin-left: 35%; ">Tentang Kami</h1>
                            <!-- News Text -->
                            <div class=" news-text">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12 col-md-12 col-12">
                                            <div class="single-image">
                                                <img src="<?= base_url('assets/') ?>guest/img/about.jpg" alt="#">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="single-main">
                            <!-- News Text -->
                            <div class="news-text">
                                <h1 class="news-title" style="color: #26547c;font-weight: bold; font-size:40px ">Apps Android Kami</h1>
                                <div class=" image-gallery">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6 col-md-6 col-12">
                                            <div class="single-image">
                                                <img src="<?= base_url('assets/') ?>guest/img/mobile.png" style="width: 40%; margin-left: 25%" alt="#">
                                            </div>
                                        </div>
                                    </div>
                                </div>
